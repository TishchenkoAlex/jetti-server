    ...
    SELECT [id], [kind], [parent], CAST(date AS DATE) [date], [document], [company], [calculated]
        , TRY_CONVERT(VARCHAR(150), JSON_VALUE(data, '$."PaymentsKind"')) [PaymentsKind]
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.PaymentBatch] ON [Register.Accumulation.PaymentBatch.v]([date], [document], [company], [calculated], [parent], [PaymentsKind], [Counterpartie], [ProductPackage], [Product], [Currency], [batch], [PayDay], [Qty], [Qty.In], [Qty.Out], [Price], [Price.In], [Price.Out], [Amount], [Amount.In], [Amount.Out], [AmountInBalance], [AmountInBalance.In], [AmountInBalance.Out]);
    GO
    ...
    SELECT [id], [kind], [parent], CAST(date AS DATE) [date], [document], [company], [calculated]
        ...
        , TRY_CONVERT(VARCHAR(150), JSON_VALUE(data, '$."SourceTransaction"')) [SourceTransaction]
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.AP] ON [Register.Accumulation.AP.v]([date], [document], [company], [calculated], [parent], [currency], [AO], [Supplier], [Department], [SupplierDocDate], [PayDay], [Amount], [Amount.In], [Amount.Out], [AmountInBalance], [AmountInBalance.In], [AmountInBalance.Out], [AmountInAccounting], [AmountInAccounting.In], [AmountInAccounting.Out], [AmountToPay], [AmountToPay.In], [AmountToPay.Out], [AmountIsPaid], [AmountIsPaid.In], [AmountIsPaid.Out]);
    GO
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.AR] ON [Register.Accumulation.AR.v]([date], [document], [company], [calculated], [parent], [currency], [AO], [Customer], [Department], [PayDay], [AR], [AR.In], [AR.Out], [AmountInBalance], [AmountInBalance.In], [AmountInBalance.Out], [AmountInAccounting], [AmountInAccounting.In], [AmountInAccounting.Out], [AmountToPay], [AmountToPay.In], [AmountToPay.Out], [AmountIsPaid], [AmountIsPaid.In], [AmountIsPaid.Out]);
    GO
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Balance] ON [Register.Accumulation.Balance.v]([date], [document], [company], [calculated], [parent], [Balance], [Analytics], [Department], [Amount], [Amount.In], [Amount.Out], [Info]);
    GO
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Balance.Report] ON [Register.Accumulation.Balance.Report.v]([date], [document], [company], [calculated], [parent], [currency], [Balance], [Analytics], [Analytics2], [Analytics3], [Analytics4], [Analytics5], [Department], [Amount], [Amount.In], [Amount.Out], [AmountInBalance], [AmountInBalance.In], [AmountInBalance.Out], [AmountInAccounting], [AmountInAccounting.In], [AmountInAccounting.Out], [Info]);
    GO
    ...
    SELECT [id], [kind], [parent], CAST(date AS DATE) [date], [document], [company], [calculated]
        ...
        , TRY_CONVERT(VARCHAR(150), JSON_VALUE(data, '$."KindTimekeeping"')) [KindTimekeeping]
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."Employee"')) [Employee]
    ...
    SELECT [id], [kind], [parent], CAST(date AS DATE) [date], [document], [company], [calculated]
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."CashFlow"')) [CashFlow]
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."currency"')) [currency]
        , TRY_CONVERT(VARCHAR(150), JSON_VALUE(data, '$."PaymentKind"')) [PaymentKind]
        , TRY_CONVERT(MONEY, JSON_VALUE(data, N'$."Amount"')) * IIF(kind = 1, 1, -1) [Amount]
        , TRY_CONVERT(MONEY, JSON_VALUE(data, N'$."Amount"')) * IIF(kind = 1, 1,  null) [Amount.In]
        , TRY_CONVERT(MONEY, JSON_VALUE(data, N'$."Amount"')) * IIF(kind = 1, null,  1) [Amount.Out]
        , TRY_CONVERT(MONEY, JSON_VALUE(data, N'$."AmountInBalance"')) * IIF(kind = 1, 1, -1) [AmountInBalance]
    ...
    SELECT [id], [kind], [parent], CAST(date AS DATE) [date], [document], [company], [calculated]
        ...
        , TRY_CONVERT(VARCHAR(150), JSON_VALUE(data, '$."DeliveryType"')) [DeliveryType]
    ...
    SELECT [id], [kind], [parent], CAST(date AS DATE) [date], [document], [company], [calculated]
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."Employee"')) [Employee]
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."Analytics"')) [Analytics]
        , TRY_CONVERT(VARCHAR(150), JSON_VALUE(data, '$."SalaryKind"')) [SalaryKind]
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."PL"')) [PL]
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."PLAnalytics"')) [PLAnalytics]
        , TRY_CONVERT(VARCHAR(150), JSON_VALUE(data, '$."Status"')) [Status]
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Salary] ON [Register.Accumulation.Salary.v]([date], [document], [company], [calculated], [parent], [currency], [KorrCompany], [Department], [Person], [Employee], [Analytics], [SalaryKind], [PL], [PLAnalytics], [Status], [IsPortal], [Amount], [Amount.In], [Amount.Out], [AmountInBalance], [AmountInBalance.In], [AmountInBalance.Out], [AmountInAccounting], [AmountInAccounting.In], [AmountInAccounting.Out]);
    GO
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.CashToPay] ON [Register.Accumulation.CashToPay.v]([date], [document], [company], [calculated], [parent], [currency], [CashRequest], [BankAccountPerson], [OperationType], [CashRecipient], [CashFlow], [Status], [Contract], [Department], [Loan], [CashOrBank], [ExpenseOrBalance], [ExpenseAnalytics], [BalanceAnalytics], [PayDay], [Amount], [Amount.In], [Amount.Out]);
    GO
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.CharityAnalytic] ON [Register.Accumulation.CharityAnalytic.v]([date], [document], [company], [calculated], [parent], [currency], [Creator], [CreatorContract], [Recipient], [RecipientContract], [Batch], [Source], [Analytics], [MovementType], [Amount], [Amount.In], [Amount.Out], [AmountInBalance], [AmountInBalance.In], [AmountInBalance.Out], [AmountInAccounting], [AmountInAccounting.In], [AmountInAccounting.Out], [Info]);
    GO
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Intercompany] ON [Register.Accumulation.Intercompany.v]([date], [document], [company], [calculated], [parent], [currency], [Intercompany], [LegalCompanySender], [LegalCompanyRecipient], [Contract], [OperationType], [Analytics], [Amount], [Amount.In], [Amount.Out], [AmountInBalance], [AmountInBalance.In], [AmountInBalance.Out], [AmountInAccounting], [AmountInAccounting.In], [AmountInAccounting.Out]);
    GO
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Acquiring] ON [Register.Accumulation.Acquiring.v]([date], [document], [company], [calculated], [parent], [currency], [AcquiringTerminal], [AcquiringTerminalCode1], [Department], [OperationType], [CashFlow], [PaymantCard], [PayDay], [DateOperation], [DatePaid], [AuthorizationCode], [Amount], [Amount.In], [Amount.Out], [AmountInBalance], [AmountInBalance.In], [AmountInBalance.Out], [AmountOperation], [AmountOperation.In], [AmountOperation.Out], [AmountPaid], [AmountPaid.In], [AmountPaid.Out]);
    GO
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.PromotionPoints] ON [Register.Accumulation.PromotionPoints.v]([date], [document], [company], [calculated], [parent], [RetailNetwork], [Department], [OwnerInner], [OwnerExternal], [PromotionChannel], [currency], [batch], [OrderId], [ExpiredAt], [Qty], [Qty.In], [Qty.Out], [Amount], [Amount.In], [Amount.Out], [AmountInBalance], [AmountInBalance.In], [AmountInBalance.Out], [AmountInAccounting], [AmountInAccounting.In], [AmountInAccounting.Out]);
    GO
    ...
    SELECT [id], [kind], [parent], CAST(date AS DATE) [date], [document], [company], [calculated]
        ...
        , TRY_CONVERT(VARCHAR(150), JSON_VALUE(data, '$."StaffingType"')) [StaffingType]
    ...
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.StaffingTable] ON [Register.Accumulation.StaffingTable.v]([date], [document], [company], [calculated], [parent], [Department], [DepartmentCompany], [StaffingType], [StaffingTablePosition], [Employee], [Person], [SalaryAnalytic], [currency], [SalaryRate], [SalaryRate.In], [SalaryRate.Out], [Amount], [Amount.In], [Amount.Out], [AmountPrepay], [AmountPrepay.In], [AmountPrepay.Out]);
    GO
