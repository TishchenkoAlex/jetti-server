...
------------------------------ BEGIN Operation.AdditionalParametersDepartment ------------------------------
      ...
      , ISNULL(TRY_CONVERT(NVARCHAR(150), JSON_VALUE(doc,N'$."paymentGateway"')), '') [paymentGateway]
      ...
      , ISNULL(TRY_CONVERT(NVARCHAR(150), JSON_VALUE(doc,N'$."StickerSettings"')), '') [StickerSettings]
      , ISNULL(TRY_CONVERT(NVARCHAR(150), JSON_VALUE(doc,N'$."ThermalName"')), '') [ThermalName]
      ...
      , ISNULL(TRY_CONVERT(NVARCHAR(150), JSON_VALUE(doc,N'$."provider"')), '') [provider]
...
------------------------------ BEGIN Operation.AutoAdditionSettings ------------------------------
      ...
      , ISNULL(TRY_CONVERT(NVARCHAR(150), JSON_VALUE(doc,N'$."AdditionalType"')), '') [AdditionalType]
      ...
      , ISNULL(TRY_CONVERT(NVARCHAR(150), JSON_VALUE(doc,N'$."DeliveryType"')), '') [DeliveryType]
      FROM dbo.[Documents]
...
------------------------------ BEGIN Operation.CHECK_JETTI_FRONT ------------------------------
      ...
      , ISNULL(TRY_CONVERT(NVARCHAR(150), JSON_VALUE(doc,N'$."TypeDocument"')), '') [TypeDocument]
      , TRY_CONVERT(DATETIME, JSON_VALUE(doc,N'$."PrintTime"'),127) [PrintTime]
      , ISNULL(TRY_CONVERT(NVARCHAR(150), JSON_VALUE(doc,N'$."TypeOfFranchise"')), '') [TypeOfFranchise]
      , ISNULL(TRY_CONVERT(NVARCHAR(150), JSON_VALUE(doc,N'$."DeliveryType"')), '') [DeliveryType]
...
------------------------------ BEGIN Operation.OnlineSalesManagementSettings ------------------------------
      ...
      , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(doc, N'$."RetailNetwork"')) [RetailNetwork]
      , ISNULL(TRY_CONVERT(NVARCHAR(150), JSON_VALUE(doc,N'$."TypeShowcase"')), '') [TypeShowcase]
